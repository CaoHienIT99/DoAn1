...
namespace DA1.Areas.Admin.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SupplierID,SupplierName,Adress,Email,PhoneNumber")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplierID,SupplierName,Adress,Email,PhoneNumber")] Supplier supplier)
        {
